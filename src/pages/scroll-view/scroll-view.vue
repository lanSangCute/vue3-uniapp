<template>
  <view class="content">
    <view style="height:100%;width:100%">
        <scroll-view :refresher-threshold="50" :scroll-y="true" style="height:calc(100vh - 44px)" :refresher-enabled="true" refresher-default-style="black"  :refresher-triggered="triggered"
...
let data = reactive(request()) as Array<Item>;
